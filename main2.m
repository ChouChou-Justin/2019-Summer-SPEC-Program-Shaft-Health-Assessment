...
figure;
hist_H1=histogram(training(1:20,1),'BinWidth',1e-06);
hold on
hist_F1=histogram(training(21:40,1),'BinWidth',1e-06);
title('21.8 Hz- Histogram')
xlabel('value')
ylabel('# observation')
legend('Healthy','Faulty')
...
figure;
hist_H2=histogram(training(1:20,2),'BinWidth',1e-06);
hold on
hist_F2=histogram(training(21:40,2),'BinWidth',1e-06);
